#this section is copy pasted from resnet.py in the geometric analysis of neural collapse paper / models
import sys
...
def main():
    ...
    #trained on cifar10, load defaults into memory
    model = resnet18()

    file_path = r"C:\Users\plano\Documents\1-SCHOOL STUFF\2024-2025 Year 3\Research Stuff\Code\IID\IDM+ours\nn_models\SGD_epoch_200.pth"
    state_dict = torch.load(file_path)
    model.load_state_dict(state_dict)
    #print("successfully loaded? model type is " + str(type(model)))
